...
it('should append a query parameter to the URL', function () {
  const opts = {
    uri: 'http://httpbin.org/anything?a=b',
    qs: {
      'test': 'true',
      'foo': 'bar'
    },
...
it('should get a 200 response after requesting a HTTPS link', function () {
  const opts = {
